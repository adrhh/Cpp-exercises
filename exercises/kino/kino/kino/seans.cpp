...
Seans::Seans(Film* f, Sala* s, dddata dt) : film(f), sala(s), zajete_miejsca(0), data_seansu(dt), seans_id(++counter) {}
...
void		 Seans::set_zajete(unsigned int i)		{ zajete_miejsca = i; }
